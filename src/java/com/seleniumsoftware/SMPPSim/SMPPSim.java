 ...
 * http://www.seleniumsoftware.com
 * $Header: /var/cvsroot/SMPPSim2/src/java/com/seleniumsoftware/SMPPSim/SMPPSim.java,v 1.34 2014/05/25 10:42:26 martin Exp $
 ****************************************************************************
...
public class SMPPSim {
	...
	private static final String version = "2.6.11";
	...
	private static boolean simulate_variable_submit_sm_response_times = false;
	...
	public void start(String properties_file_name) throws Exception {
		...
		File test_file = new File(properties_file_name);
		if (!test_file.exists()) {
			logger.severe("Specified properties file does not exist:" + properties_file_name);
	...
	public static boolean isSimulate_variable_submit_sm_response_times() {
		return simulate_variable_submit_sm_response_times;
	}
